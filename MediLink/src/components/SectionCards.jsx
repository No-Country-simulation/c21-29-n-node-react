  ...
  return (
    <div className="bg-[#DDE6EB] py-10  ">
      ...
      <div className="flex justify-evenly gap-8 mt-8">
        {/* Primera card */}
        <div className="bg-white border-[#1D2E50] shadow-[0_5px_10px_rgba(0,0,0,0.25)] rounded-[20px] p-[32px] w-[400px] min-h-[485px] max-h-[576px] gap-[35px]">
          <div className="flex flex-col items-center">
            {/* Icono arriba del título */}
            <img
              className="text-[#1D2E50] mb-8 items-center"
              src={Doctor}
              alt="Icono de Doctor"
            />
